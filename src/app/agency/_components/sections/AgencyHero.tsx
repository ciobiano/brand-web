...
export default function AgencyHero() {
	...
	return (
		<section ref={rootRef} className="relative bg-white text-black">
			<div className="mt-48 flex w-full flex-col gap-6 px-10 pb-24">
				<div className="space-y-8 px-10 pb-20">
					<p className="max-w-md font-medium uppercase text-black/60">
									...
									>
										<div className="relative h-[32rem] w-[57vw] max-w-[1022px] sm:h-[54vh] lg:max-h-[70vh]">
											...
											{shouldRenderLabel && (
												...
												>
													<p className={`text-3xl ${labelTextClasses[labelVariant]}`}>
														{slide.label}
													</p>
												</div>
											)}
				...
				<div className="mx-auto w-full overflow-hidden rounded-[32px] border border-clou-black/25 bg-clou-black px-6 py-16 text-clou-white">
