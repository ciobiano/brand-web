			...
			<>
				<div className="pointer-events-auto relative z-10 flex h-[32rem] w-full flex-col gap-6 p-10 text-left sm:h-[70vh]">
					<div className="flex items-center gap-4">
						<span className="flex h-16 w-16 items-center justify-center rounded-full bg-kainé-gray/20" />
						<div className="flex flex-col gap-1">
							<h1 className="text-lg font-medium text-kainé-white">
								{testimonial.name}
							</h1>
							<span className="text-base text-kainé-gray">
								{testimonial.role}
							</span>
						</div>
					</div>
					...
					<div className="flex flex-1 items-center justify-center">
						<p className="max-w-3xl text-start text-4xl font-medium leading-tight text-kainé-gray lg:text-5xl">
							{testimonial.quote}
						</p>
					</div>
				</div>
