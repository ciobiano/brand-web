		...
		<section ref={sectionRef} className="py-24 px-4 sm:px-6 lg:px-10">
			<div className="max-w-[95rem] mx-auto">
				<div className="mb-16 lg:mb-24">
					...
					<h2
						data-team-title
						className="text-4xl font-medium leading-tight sm:text-5xl lg:text-6xl text-kainé-black opacity-0"
					>
						Die Menschen
						<br />
						hinter kainé
				...
				>
					{teamMembers.map((member) => (
						...
						>
							...
							<h3 className="text-base font-medium text-kainé-black sm:text-lg">
								{member.name}
							</h3>
